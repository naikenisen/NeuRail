...
# Répertoire de mails envoyés par défaut
_default_sent_dir = "/home/naiken/sent"
...
# Répertoire de stockage des mails envoyés
SENT_DIR = str(_PATHS.get("sent_dir", _default_sent_dir)).strip() or _default_sent_dir
